...
public class EstudianteUI extends JFrame{
    ...
    public EstudianteUI() {
        this.controlador = new EstudianteControlador("UI-Controlador");
        initComponents();
        cargarTabla();
    }

    private void initComponents() {
        setTitle("CRUD Estudiantes - MVC + Singleton + Factory");
    ...
    private void accionGuardar() {
        ...
        try {
            ...
            // Usar controlador que internamente usa Factory
            controlador.accionCrear(id, nombres, edad);
    ...
    private void accionEditar() {
        try {
            ...
            // Usar controlador que internamente usa Factory
            controlador.accionActualizar(id, nombres, edad);
    ...
    private void accionEliminar() {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            boolean ok = controlador.accionEliminar(id);
            if (ok) {
    ...
    private void cargarTabla() {
        ...
        for (Estudiante e : controlador.accionListar()) {
