...
public class EstudianteControlador {
    ...
    /**
     * Acción: Crear un nuevo estudiante usando Factory Pattern
     */
    ...
    /**
     * Acción: Actualizar un estudiante existente usando Factory Pattern
     */
    public boolean accionActualizar(String id, String nombres, int edad) {
        try {
            // Usar Factory para validar datos antes de actualizar
            Estudiante estudiante = EstudianteFactory.crearEstudiante(id, nombres, edad);
